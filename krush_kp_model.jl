...
# ╔═╡ 1af6beec-f119-495c-9aca-67c5cbc3d362
begin
		using CSV
		using DataFrames
		using HTTP
...
# ╔═╡ 040eb91c-37b9-403f-b055-5c05a53c57c5
begin
    using BSON
    
    # Save the entire trained model as a .bson file
    save_path = "krush_kp_mlp_model.bson"
    
    # The @save macro takes the file path and the variable name of your model
    BSON.@save  save_path mlp_model
...
MoleculeFlow = "0907176b-47b3-4e96-be91-0e9bb91fb14f"
...
manifest_format = "2.0"
project_hash = "40ff8f78e4c9f4ca25fc5ad648c794e8a202e884"
...
[[deps.MolecularGraph]]
deps = ["Colors", "Dates", "DelimitedFiles", "GeometryBasics", "Graphs", "JSON", "LinearAlgebra", "MakieCore", "OrderedCollections", "Printf", "Statistics", "StructUtils", "YAML", "coordgenlibs_jll", "libinchi_jll"]
git-tree-sha1 = "47fd91dc4409b1d92a560c0ab10e019bcafb8652"
uuid = "6c89ec66-9cd8-5372-9f91-fabc50dd27fd"
version = "0.22.0"

    [deps.MolecularGraph.extensions]
    CairoExt = "Cairo"
    RDKitExt = "RDKitMinimalLib"

    [deps.MolecularGraph.weakdeps]
    Cairo = "159f3aea-2a34-519c-b102-8c37f9878175"
    RDKitMinimalLib = "44044271-7623-48dc-8250-42433c44e4b7"

[[deps.MoleculeFlow]]
deps = ["CondaPkg", "Dates", "Distributed", "Graphs", "Images", "LinearAlgebra", "MbedTLS_jll", "Printf", "PythonCall", "Reexport", "Serialization", "Statistics"]
git-tree-sha1 = "8b21c75b376e7ef0905d4156297a9fd63aa7c0d6"
uuid = "0907176b-47b3-4e96-be91-0e9bb91fb14f"
version = "0.6.0"
